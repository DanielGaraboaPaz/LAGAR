...
class Writer:
        ...
        def print_module_info(self,filename,r,t):
            
            if  self.writer_iterator == 0:
                print('\n')
                print('++++++++++++++++++++++++++++++++\r')
                print('LAGAR Writer-Module information\r')
                print('*+++++++++++++++++++++++++++++++\r')
                
            print('File:', filename + self.extension,'\t', 'Step:', self.writer_iterator,'\t','Time',t[0],\
            'Particles:', str(r.shape[0]),'\t','variables:', str(r.shape[1]))
            print('\n')
            return
        ...
        def save_step(self,r,t):
            ...
            if self.save_condition(t):
                ...
                if self.mem_or_disk == 'mem':
                    ...
                    self.print_module_info(filename,r,t)
